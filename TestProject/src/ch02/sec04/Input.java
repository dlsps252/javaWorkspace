...
public class Input {
	...
	Scanner sc = new Scanner(System.in); // 키보드를 통해 입력된 byte 코드를 메소드에 따라 형변환 된 결과값 반환
	int num1, num2;
	
	System.out.println("첫번째 숫자 입력 :");
	// 사용자가 입력 후 enter키 입력할때 까지 대기
	num1 = sc.nextInt(); // 입력된 값을 정수로 변환 - 변환 안되면 오류
	...
	// 문자열로 입력받은 후에 한 문자만 추출 : String.charAt(0) : 첫번째 문자 추출 char 반환
